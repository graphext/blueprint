...
export const CARD_INTENT_PRIMARY = `${NS}-g-intent-primary`
...
export const TABS_FILL_WIDTH = `${NS}-g-tabs-fill-width`;
...
/* TABLE */
export const TABLE_WITH_SAME_BG_COLOR_AND_GRID = `${NS}-g-table-with-same-bg-color-and-grid`;

/* EDITABLE TEXT */
export const EDITABLE_TEXT_SMALL = `${NS}-g-editable-text-small`;
